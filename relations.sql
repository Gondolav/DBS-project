...
CREATE TABLE Offered_in_city
(
    ciid INT,
    lid INT,
    PRIMARY KEY (ciid, lid),
    FOREIGN KEY (ciid) REFERENCES City(ciid),
    FOREIGN KEY (lid) REFERENCES Listing(lid)
);

CREATE TABLE Offered_in_country
(
    coid INT,
    lid INT,
    PRIMARY KEY (coid, lid),
...
(
    ...
    neighbourhood_overview TEXT NOT NULL,
    notes TEXT NOT NULL,
    transit TEXT NOT NULL,
    laccess TEXT NOT NULL,
